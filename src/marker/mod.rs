...
enum Segment {
    ...
    /// The first parameter in a marker segment is the two-byte length parameter.
    /// This length encodes the number of bytes in the marker segment, including the length
